/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 30da394315417d124b2ed8acdb591045)
// Runtime types generated with workerd@1.20260730.1 2026-08-05 nodejs_compat
interface __BaseEnv_Env {
	REPLAY_CACHE: R2Bucket;
	ASSETS: Fetcher;
	ENVIRONMENT: "production";
	GATEWAY_ID: "default-gateway";
	MODEL_ALIASES: "{\"stavka/commander\":{\"seat\":\"claude\",\"model\":\"claude-fable-5\"},\"stavka/sergeant\":{\"seat\":\"codex\",\"model\":\"gpt-5.6-luna\"},\"stavka/heavy\":{\"seat\":\"codex\",\"model\":\"gpt-5.6-terra\"}}";
	...
	MASKIROVKA_GATEWAY: DurableObjectNamespace<import("./src/index").MaskirovkaGateway>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MaskirovkaGateway";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "GATEWAY_ID" | "MODEL_ALIASES" | "CONTAINER_SLEEP_AFTER" | "MASKIROVKA_MODE" | "MASKIROVKA_CLAUDE_MONTHLY_CREDIT_USD" | "MASKIROVKA_CODEX_WINDOW_CALL_LIMIT" | "MASKIROVKA_CODEX_WINDOW_TOKEN_LIMIT" | "MASKIROVKA_CODEX_WINDOW_HOURS" | "MASKIROVKA_MAX_RESPONSE_BYTES">> {}
}
